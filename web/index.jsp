<%--  
    Document   : index
    Created on : Nov 25, 2018, 5:57:39 PM
    Author     : agashe
--%>

<%@page import="UserTweetsPkg.NLP"%>
...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="mainPageStyle/css/bootstrap.min.css">
    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,400i,500,700,900" rel="stylesheet">
    <!-- Simple line Icon -->
    <link rel="stylesheet" href="mainPageStyle/css/simple-line-icons.css">
    <!-- Themify Icon -->
    <link rel="stylesheet" href="mainPageStyle/css/themify-icons.css">
    <!-- Hover Effects -->
    <link rel="stylesheet" href="mainPageStyle/css/set1.css">
    <!-- Main CSS -->
...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="index.html">TweetFlix</a>
    ...
    <section class="slider d-flex align-items-center">
         <!--<img src="mainPageStyle/images/avengers_assembled.jpg" class="img-fluid" alt="#">--> 
        <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slider-content_wrap">
                                    <h1>Discover Great Movies Here</h1>
                                    <h5>Let's uncover the best movies with your Twitter Friends.</h5>
                                </div>
                            </div>
                        </div>
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-10">
                                <form class="form-wrap mt-4">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <input type="text" placeholder="See what your friends are watching!" class="btn-group1">
...
//                out.print(screenName);
            try
            {
            UserTweetsCls[] userTweetCls = GetTwitterInfo.getUserTweets(screenName);
            NLP.init();
            ...
            <div class="row">
                <div class="col-md-12 featured-responsive">
                    <div class="featured-place-wrap">
                        <!--<a href="detail.html">-->
                            <!--<img src="mainPageStyle/images/featured1.jpg" class="img-fluid" alt="#">-->
                            <% 
                            if(NLP.findSentiment(twt)==0){
                            %>
                            <span class="featured-rating-orange"><%= NLP.findSentiment(twt) +1 %></span>
                            <% }
                                else if(NLP.findSentiment(twt)==1){
                            
                            %>
                            <span class="featured-rating-orange"><%= NLP.findSentiment(twt)+1 %></span>
                            <% }
                                else if(NLP.findSentiment(twt)==2){
                            
                            %>
                            <span class="featured-rating-orange"><%= NLP.findSentiment(twt)+1 %></span>
                            <% }
                                else if(NLP.findSentiment(twt)==3){
                            
                            %>
                            <span class="featured-rating-green"><%= NLP.findSentiment(twt)+1 %></span>
                            <% }
                                else if(NLP.findSentiment(twt)==4){
                            ...
                            <div class="featured-title-box">
                                <h6><%= userTweetCls[i].getUserName() %></h6>
                                <p>Movie </p> <span>• </span>
                                <ul>
...
<!--                                    <li><span class="icon-screen-smartphone"></span>
                                    ...
                                    <li><span class="icon-link"></span>
                                        <p><%="https://twitter.com/"+ userTweetCls[i].getScreenName() %></p>
                                    </li>
                                </ul>
    ...
    <script src="mainPageStyle/js/jquery-3.2.1.min.js"></script>
    <script src="mainPageStyle/js/popper.min.js"></script>
    <script src="mainPageStyle/js/bootstrap.min.js"></script>
